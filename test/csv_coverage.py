...
# coverage_iter_graph(people_path, location_path, "../output/coverage/地点人词.csv", False, "location & people")
# coverage_iter_graph(stuff_path, location_path, "../output/coverage/物象地点.csv", False, "location & stuff")
# coverage_iter_graph(time_path, location_path, "../output/coverage/地点时词.csv", False, "location & time")
coverage_iter_graph(status_path, location_path, "../output/coverage/地点状态.csv", False, "location & status")
# coverage_iter_graph(location_path, location_path, "../output/coverage/地点地点.csv", True, "location & location")
#
# coverage_iter_graph(idf_people_path, idf_location_path, "../output/coverage/地点人词.csv", False, "location & people")
# coverage_iter_graph(idf_stuff_path, idf_location_path, "../output/coverage/物象地点.csv", False, "location & stuff")
# coverage_iter_graph(idf_time_path, idf_location_path, "../output/coverage/地点时词.csv", False, "location & time")
coverage_iter_graph(idf_status_path, idf_location_path, "../output/coverage/地点状态.csv", False, "location & status")
# coverage_iter_graph(idf_location_path, idf_location_path, "../output/coverage/地点地点.csv", True, "location & location")
