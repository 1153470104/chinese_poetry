...
txt_wraggle.add_id("../output/tfidf_word/人词500.txt", "../output/tfidf_word/id人词500.txt")
txt_wraggle.add_id("../output/tfidf_word/物象词500.txt", "../output/tfidf_word/id物象词500.txt")
txt_wraggle.add_id("../output/tfidf_word/地点词500.txt", "../output/tfidf_word/id地点词500.txt")
txt_wraggle.add_id("../output/tfidf_word/状态词500.txt", "../output/tfidf_word/id状态词500.txt")
txt_wraggle.add_id("../output/tfidf_word/时词500.txt", "../output/tfidf_word/id时词500.txt")
