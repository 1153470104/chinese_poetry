...
stuff2_list100 = get_txt_top("../output/tfidf_word/物象词（去地点）500.txt", 100)
...
#
excel_export_co_matrix(stuff2_list100, stuff2_list100, "../output/tfidf_word/newtf物象物象（去地点）100.xls")
excel_export_co_matrix(stuff2_list100, location_list100, "../output/tfidf_word/newtf地点物象（去地点）100.xls")
